...
module RuboCop
  module Cop
    module Rails
      # This cop identifies calls to where.not with multiple hash arguments.
      #
      ...
      class WhereNotWithMultipleArguments < Base
        MSG = 'Use a SQL statement instead of where.not with multiple arguments.'
